  ...
  return (
    <>
      <div className="lg:col-span-3">
        <div>
          <Link to="/admin/product-form" className="rounded-md bg-green-600 mx-10 my-5 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-green-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Add New Product</Link>
        </div>
        <div className="bg-white">
            ...
            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
              {products.length > 0 ? products.map((product) => (
                <div>
                  ...
                  <div className='mt-4'>
                    <Link to={`/admin/product-form/edit/${product.id}`} className="rounded-md bg-indigo-600 my-5 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Edit Product</Link>
                  </div>
                </div>
              )) : <span>NO DATA</span>}
            </div>
